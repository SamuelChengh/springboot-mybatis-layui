...
layui.define(['jquery', 'layer'], function (exports) {
    ...
    var obj = function (config) {
        ...
        this.config = {
            ...
            selected: [],   // 默认选中值
            field: {idName: 'id', titleName: 'name', statusName: 'status'} // 候选项数据的键名 status=0为禁用状态
        }
    ...
    obj.prototype.render = function () {
        ...
        if ($('#lay-ext-mulitsel-style').length == 0) {
            var style = '.lay-ext-mulitsel .layui-form-select dl dd div{margin-top:0px!important;}.lay-ext-mulitsel .layui-form-select dl dd.layui-this{background-color:#fff}.lay-ext-mulitsel .layui-input.multiple{line-height:auto;height:auto;padding:4px 10px 4px 10px;overflow:hidden;min-height:30px;margin:-30px 0 3px 0;left:0;z-index:99;position:relative;background:#fff;}.lay-ext-mulitsel .layui-input.multiple a{padding:2px 5px;background:#01AAED;border-radius:2px;color:#fff;display:block;line-height:15px;height:15px;margin:2px 5px 2px 0;float:left;}.lay-ext-mulitsel .layui-input.multiple a i{margin-left:4px;font-size:14px;} .lay-ext-mulitsel .layui-input.multiple a i:hover{background-color:#009E94;border-radius:2px;}.lay-ext-mulitsel .danger{border-color:#FF5722!important}.lay-ext-mulitsel .tips{pointer-events: none;position: absolute;left: 10px;top: 5px;color:#757575;}';
