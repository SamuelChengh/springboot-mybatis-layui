...
public class DateUtil {
     ...
     *  date 要格式化的日期字符串: 10位 yyyy/MM/dd或yyyy-MM-dd或yyyy:MM:dd
     * @return 返回格式化后的日期
     */
     ...
     *  date -要格式化的时间字符串: 6位(HHmmss)或5位(Hmmss)
     * @return String - 返回格式化后的时间 <br>
    ...
    /**
     * 获取一个月的最后一天。 <br>
     * 例如20030111,即一月份的最后一天是2003-01-31
     ...
     * @author zhaoxuepu
     */
    public static String getLastTimeInterval(int week) {
        ...
        calendar1.add(Calendar.DATE, offset1 - 7*week);
        calendar2.add(Calendar.DATE, offset2 - 7*week);
        // System.out.println(sdf.format(calendar1.getTime()));// last Monday
        String lastBeginDate = chineseDateFormat.format(calendar1.getTime());
        // System.out.println(sdf.format(calendar2.getTime()));// last Sunday
        String lastEndDate = chineseDateFormat.format(calendar2.getTime());
     ...
     * @author zhaoxuepu
     */
    public static String getLastTimeIntervalMonth(int month) {

        //获取前月的第一天
        Calendar   cal_1=Calendar.getInstance();//获取当前日期
        cal_1.add(Calendar.MONTH, -1*month);
        cal_1.set(Calendar.DAY_OF_MONTH,1);//设置为1号,当前日期既为本月第一天
        String firstDay = chineseDateFormat.format(cal_1.getTime());
        //获取前月的最后一天
                Calendar cale = Calendar.getInstance();
         cale.set(Calendar.DAY_OF_MONTH,0);//设置为1号,当前日期既为本月第一天
        String lastDay = chineseDateFormat.format(cale.getTime());

//        System.out.println("-----1------firstDay:"+firstDay+lastDay);
